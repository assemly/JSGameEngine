...
function _setupShadow() {
    this.mBgShadow = new ShadowReceiver(this.gEngine,this.mBg);
    ...
    this.mMinionShadow = new ShadowReceiver(this.gEngine,this.mIllumMinion);
    ...
    this.mLgtMinionShaodw = new ShadowReceiver(this.gEngine,this.mLgtMinion);
