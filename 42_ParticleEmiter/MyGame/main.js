...
class MyGame extends Scene {
    constructor(gEngine) {
        super();
        this._createParticle = this._createParticle.bind(this);
        ...
        this.kParticleTexture = "assets/textures/particle.png";
        ...
        this.mAllParticles = new ParticleGameObjectSet(gEngine);
    ...
    loadScene() {
        this.gEngine.Textures.loadTexture(this.kParticleTexture);
    ...
    unloadScene() {
        ...
        this.gEngine.Textures.unloadTexture(this.kParticleTexture);
    };
    ...
    update() {
        ...
        var func = function(x, y) { this._createParticle.call(this, x, y); };
        ...
        this.mHero.update(this.mAllDyePacks, this.mAllParticles, this._createParticle);
    ...
    _createParticle(atX, atY) {
        ...
        var p = new ParticleGameObject(this.gEngine,this.kParticleTexture, atX, atY, life);
