...
const MyGame = (htmlCanvasID) => {
    ...
    gl.viewport(
        (width-width*0.8)/2,     // x position of bottom-left corner of the area to be drawn
        (height-height*0.8)/2,     // y position of bottom-left corner of the area to be drawn
        width*0.8,    // width of the area to be drawn
        height*0.8);     // height of the area to be drawn
    ...
    mat4.ortho(projMatrix,
        ...
        -10*aspect,      // distance to bottom of WC
        10*aspect,      // distance to top of WC
