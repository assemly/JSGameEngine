class SimpleShader {
    constructor(gEngine, vertexShaderFile, fragmentShaderFile) {
        // instance variables
        ...
        var vertexShader = this._loadAndCompileShader(vertexShaderFile, this.gl.VERTEX_SHADER);
        var fragmentShader = this._loadAndCompileShader(fragmentShaderFile, this.gl.FRAGMENT_SHADER);
