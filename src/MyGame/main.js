...
class MyGame extends Scene {
    ...
    unloadScene() {
        this.gEngine.LayerManager.cleanUp();
    ...
    draw() {
        ...
        this.gEngine.LayerManager.drawAllLayers(this.mCamera);

        if (this.mShowHeroCam) {
            this.mParallaxCam.setupViewProjection();
            this.gEngine.LayerManager.drawAllLayers(this.mParallaxCam);
        }
    ...
    update() {
        ...
        this.gEngine.LayerManager.updateAllLayers();
